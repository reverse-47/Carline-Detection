...
from acllite.cameracapture import CameraCapture
#import acllite.presenteragent.presenter_channel as presenter_channel
...
def parse_args():
    ...
    parser.add_argument(
        '--result_dst',
        default='/home/HwHiAiUser/mnt/GANet/tools/input',
...
def transmit_image(img):
    oss2.Bucket(oss2.Auth("LTAI5tG4214DZuezhwbEeiyn", 
			"5BEC0l3gt4jeHmGbgLPCuIQLkgEkYY"), 
		"oss-cn-shanghai.aliyuncs.com", 
		"tj-software-engineer").put_object_from_file("lane.jpg", img)
...
def main():
    ...
    acl_resource.init()
    acl_image = AclLiteImageProc()
    cap=CameraCapture(1)

    while True: 
        image = cap.read()
        #print(image)
        ii= acl_image.resize(image,1640,590)
        ii = acl_image.jpege(ii)
        ii.save("/home/HwHiAiUser/mnt/GANet/tools/input/carline/car.jpg")
        #image.save("car.jpg")
        ...
        transmit_image("/home/HwHiAiUser/mnt/GANet/tools/work_dirs/culane/watch/0_carline.car.jpg.gt.jpg")
